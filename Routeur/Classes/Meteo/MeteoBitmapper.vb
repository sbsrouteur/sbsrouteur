...
Public Class MeteoBitmapper
    ...
    Private meteocache(12 * 24 * 15, NbX * NbY - 1) As MeteoData
    ...
    Private Function GetCacheIndex() As Integer
    ...
    '                WindDir(CInt(Ix + NbX * Iy)) = (180 - mi.Dir) / 180 * PI

    '            Else
    '                WindSpeed(CInt(Ix + NbX * Iy)) = -1
